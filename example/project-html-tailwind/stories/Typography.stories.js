...
export const Type = () => `
    <div class="flex flex-col w-3/4 pb-3 mb-5 border-b-2">
        <h4 class="text-center h4 h4-400 text-type-black-secondary">
        Typography
        </h4>
        ...
        <h5 class="h5 h5-400">H5 400</h5>
        <h6 class="h6 h6-700">H6 700</h6>
        <h5 class="h6 h5-400">H5 400</h5>
        <p class="paragraph1">Paragraph 1</p>
        <p class="paragraph2">Paragraph 2</p>
        <p class="subtitle1">Subtitle 1</p>
        <p class="subtitle2">Subtitle 2</p>
